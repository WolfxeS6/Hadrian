...
NDiplomacy = {
	...
	MAX_NUM_OF_ELECTORS = 12,						-- Maximum number of electors in the interface
	MAX_FREE_CITIES = 30,
	MIN_NUM_ELECTORS_FOR_REMOVE_ELECTORATE = 10,		-- Limit is inclusive.
	HRE_PRINCE_AUTHORITY_THRESHOLD = 18,			-- Threshold below which you lose IA, and above which you gain it
	...
	LACK_OF_ELECTORS_HIT = -0.25,					-- Also applied to vassalized electors
...
NEconomy = {
	...
	COLONIAL_MAINTENANCE_FACTOR = 12.0,				-- _EDEF_COLONIAL_MAINTENANCE_FACTOR_
